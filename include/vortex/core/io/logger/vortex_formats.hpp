...
struct fmtquill::formatter<vortex::components::ERigidBodyType>
{
	...
	auto format(const vortex::components::ERigidBodyType& type, fmtquill::format_context& ctx) const
	{
		switch (type)
		{
		case vortex::components::ERigidBodyType::Static:    return fmtquill::format_to(ctx.out(), "Static");
		case vortex::components::ERigidBodyType::Kinematic: return fmtquill::format_to(ctx.out(), "Kinematic");
		case vortex::components::ERigidBodyType::Dynamic:   return fmtquill::format_to(ctx.out(), "Dynamic");
		default:                                            return fmtquill::format_to(ctx.out(), "Unknown");
		}
	}
};
...
struct fmtquill::formatter<vortex::components::VxTransformComponent>
{
	...
	{
		if (name_only) return fmtquill::format_to(ctx.out(), "VxTransformComponent");
...
struct fmtquill::formatter<vortex::components::VxBoxColliderComponent>
{
	...
	{
		if (name_only) return fmtquill::format_to(ctx.out(), "VxBoxColliderComponent");
...
struct fmtquill::formatter<vortex::components::VxCircleColliderComponent>
{
	...
	{
		if (name_only) return fmtquill::format_to(ctx.out(), "VxCircleColliderComponent");
...
struct fmtquill::formatter<vortex::components::VxCapsuleColliderComponent>
{
	...
	{
		if (name_only) return fmtquill::format_to(ctx.out(), "VxCapsuleColliderComponent");
...
struct fmtquill::formatter<vortex::components::VxRigidBodyComponent>
{
	...
	{
		if (name_only) return fmtquill::format_to(ctx.out(), "VxRigidBodyComponent");
...
struct fmtquill::formatter<vortex::components::VxMotionComponent>
{
	...
	{
		if (name_only) return fmtquill::format_to(ctx.out(), "VxMotionComponent");
...
struct fmtquill::formatter<vortex::components::VxPhysicsRuntimeComponent>
{
	...
	{
		if (name_only) return fmtquill::format_to(ctx.out(), "VxPhysicsRuntimeComponent");
...
struct fmtquill::formatter<vortex::components::VxForceAccumulatorComponent>
{
	...
	{
		if (name_only) return fmtquill::format_to(ctx.out(), "VxForceAccumulatorComponent");
