...
namespace el
{
    static int translateToRaylibKey(EKeyCode key)
    {
        ...
        case EKeyCode::End:
            return KEY_END;
        case EKeyCode::CapsLock:
            return KEY_CAPS_LOCK;
        case EKeyCode::ScrollLock:
            return KEY_SCROLL_LOCK;
        case EKeyCode::NumLock:
            return KEY_NUM_LOCK;
        case EKeyCode::PrintScreen:
            return KEY_PRINT_SCREEN;
        case EKeyCode::PauseKey:
            return KEY_PAUSE;
        ...
        case EKeyCode::Numpad9:
            return KEY_KP_9;
        case EKeyCode::NumpadDecimal:
            return KEY_KP_DECIMAL;
        case EKeyCode::NumpadDivide:
            return KEY_KP_DIVIDE;
        case EKeyCode::NumpadMultiply:
            return KEY_KP_MULTIPLY;
        case EKeyCode::NumpadSubtract:
            return KEY_KP_SUBTRACT;
        case EKeyCode::NumpadAdd:
            return KEY_KP_ADD;
        case EKeyCode::NumpadEnter:
            return KEY_KP_ENTER;
        case EKeyCode::NumpadEqual:
            return KEY_KP_EQUAL;
        case EKeyCode::Apostrophe:
            return KEY_APOSTROPHE;
        case EKeyCode::Comma:
            return KEY_COMMA;
        case EKeyCode::Hyphen:
            return KEY_MINUS;
        case EKeyCode::Plus:
            return KEY_EQUAL;
        case EKeyCode::Period:
            return KEY_PERIOD;
        case EKeyCode::ForwardSlash:
            return KEY_SLASH;
        case EKeyCode::Semicolon:
            return KEY_SEMICOLON;
        case EKeyCode::Equal:
            return KEY_EQUAL;
        case EKeyCode::LeftBracket:
            return KEY_LEFT_BRACKET;
        case EKeyCode::Backslash:
            return KEY_BACKSLASH;
        case EKeyCode::RightBracket:
